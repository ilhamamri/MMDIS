...
angular.module("angular-growl", []), angular.module("angular-growl").directive("growl", [function () {
    ...
    this.globalTimeToLive = function (b) {
        ...
        f = a
            ...
            function u(a) {
                if (G && a.translateMessage)
                    a.text = G(a.text, a.variables), a.title = G(a.title);
                else {
                    var c = p(a.text);
                    a.text = c(a.variables)
                }
                var d = t.addMessage(a);
                return b.$broadcast("growlMessage", a), s(function () {}, 0), d
            }
        ...
        this.initDirective = function (a, b) {
            return d[a] ? (this.directives[a] = d[a], this.directives[a].limitMessages = b) : this.directives[a] = {
                messages: [],
                limitMessages: b
            }, this.directives[a]
            ...
            a = a || 0;
            var b;
            return b = this.directives[a] ? this.directives[a].messages : []
        }, this.destroyAllMessages = function (a) {
            for (var b = this.getAllMessages(a), c = b.length - 1; c >= 0; c--)
                b[c].destroy();
            this.directives[a] && (this.directives[a].messages = [])
            ...
            if (e = this.directives[d.referenceId] ? this.directives[d.referenceId] : c(d.referenceId), f = e.messages, !this.onlyUnique || (angular.forEach(f, function (b) {
                ...
                return this.reverseOrder ? f.unshift(d) : f.push(d), "function" == typeof d.onopen && d.onopen(), d.ttl && -1 !== d.ttl && (d.promises.push(b(angular.bind(this, function () {
                    this.deleteMessage(d)
                }), d.ttl)), d.promises.push(b(d.countdownFunction, 1e3))), d
            }
        }, this.deleteMessage = function (a) {
            var b = this.directives[a.referenceId].messages,
                    c = b.indexOf(a);
